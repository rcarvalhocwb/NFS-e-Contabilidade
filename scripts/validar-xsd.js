...
const CASOS = {
  ...
  'IBS/CBS mínimo': { ibsCbs: { indicadorOperacao: '000001', indicadorDestinatario: 0,
    tributacao: { cst: '000', classificacaoTributaria: '000001' } } },
  'IBS/CBS com destinatário': { ibsCbs: {
    consumidorFinal: 1, indicadorOperacao: '000001', indicadorDestinatario: 1,
    ...
    tributacao: { cst: '000', classificacaoTributaria: '000001' } } },
  'IBS/CBS diferimento e estorno': { ibsCbs: { indicadorOperacao: '000001', indicadorDestinatario: 0,
    tributacao: { cst: '000', classificacaoTributaria: '000001',
  ...
  'imunidade': { valores: { valorServico: 1000, tributacaoIssqn: 4, tipoImunidade: 2 } },
  'não incidência': { valores: { valorServico: 1000, tributacaoIssqn: 3 } },
